...
How to use:
    ...
    The output file is generated. Never edit it by hand - put fixes in
    ObsidianDiscord.theme.css, which is layered on top of Material.
"""
...
def main() -> None:
    ...
    theme = IMPORT_RE.sub("", THEME_PATH.read_text(encoding="utf-8"))

    OUTPUT_PATH.write_text(
        "/*\n"
        " * GENERATED by scripts/build_browser_css.py - do not edit.\n"
        " *\n"
        ...
        " * this one is overwritten on every build.\n"
